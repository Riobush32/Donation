                ...
                <div class="grid grid-cols-1 gap-6 mt-4">
                    ...
                    <div>
                        ...
                        <input class="form-input w-full mt-2 rounded-md bg-gray-200 focus:bg-white" type="text"
                            name="title" value="{{ old('title', $campaign->title) }}" placeholder="Judul Campaign">
                        @error('title')
                    ...
                    <div>
                        ...
                        <select class="w-full border bg-gray-200 focus:bg-white rounded px-3 py-2 outline-none"
                            ...
                            <option class="py-1" value="{{ $category->id }}" @if($campaign->category_id ==
                    ...
                    <div>
                        ...
                        <textarea name="description"
                            rows="5">{{ old('description', $campaign->description) }}</textarea>
                        @error('description')
                        <div class="w-full bg-red-200 shadow-sm rounded-md overflow-hidden mt-2">
                            <div class="px-4 py-2">
                                <p class="text-gray-600 text-sm">{{ $message }}</p>
                    ...
                    <div>
                        ...
                        <input class="form-input w-full mt-2 rounded-md bg-gray-200 focus:bg-white p-3" type="number"
                            name="target_donation" value="{{ old('target_donation', $campaign->target_donation) }}"
                    ...
                    <div>
                        ...
                        <input class="form-input w-full mt-2 rounded-md bg-gray-200 focus:bg-white p-3" type="date"
                            name="max_date" value="{{ old('max_date', $campaign->max_date) }}">
                        @error('max_date')
                        <div class="w-full bg-red-200 shadow-sm rounded-md overflow-hidden mt-2">
                            <div class="px-4 py-2">
                                <p class="text-gray-600 text-sm">{{ $message }}</p>
